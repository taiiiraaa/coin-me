...
// form submit
$('#form-coin').on("submit", function(event){
    event.preventDefault();
    event.stopPropagation();
    
    var userInputAmount = document.getElementById("amount").value;
    var penceValue = coin.inputToPence(userInputAmount);
    console.log(penceValue);
    
    var penceValueInCoins = coin.penceToCoins(penceValue);
    coin.display(penceValueInCoins); 
    console.log(penceValueInCoins);
});
